...
(5, 'KDD 921E', NULL, NULL, 55, NULL, 0, NULL);
...
ALTER TABLE `booking`
  ...
  ADD CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`seat_id`) REFERENCES `bus_seats` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT,
...
--
ALTER TABLE `ticket`
  ADD CONSTRAINT `ticket_ibfk_1` FOREIGN KEY (`passenger_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

--
-- Constraints for table `vehicle`
--
ALTER TABLE `vehicle`
  ADD CONSTRAINT `vehicle_ibfk_1` FOREIGN KEY (`route_id`) REFERENCES `routes` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT,
  ADD CONSTRAINT `vehicle_ibfk_2` FOREIGN KEY (`driver_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;
COMMIT;
