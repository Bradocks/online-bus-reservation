...
$query="SELECT * FROM sorted_orders WHERE senderId=$senderId"; /* sql query to select from sorted_orders where senderId is t
he $senderId  value */
...
if ($count> 0) {     
    ...
    $query="SELECT * FROM pending_orders_client WHERE sender_id=$senderId"; /* sql query to select from pending_orders_client table
