...
require_once("../utils/reports/StaffReport.php");
...
<body>
    ...
    function list_of_staff($conn)
    {
        ...
        $generator = new StaffReportGenerator($conn);
        $generator->render_filters('listOfStaff');

        //mysqli query to the database to select all from the staff table
        $staff = "select * from staff " . $generator->filter_query();
...
and stores the result in the $result variable. */
    ...
    function list_of_vehicles($conn)
    {
        ...
        $generator = new VehicleReportGenerator($conn);
        $generator->render_filters('listOfVehicles');

        //mysqli query to the database to select all from the staff table
        $vehicles = $generator->filter_query();
...
and stores the result in the $result variable. */
    ...
    function list_of_bookings($conn)
    {
        ...
        $generator->render_filters('listOfbookings');
    ...
    function list_of_passengers($conn)
    {
        ...
        $generator = new PassengerReportGenerator($conn);
        $generator->render_filters('listOfpassengers');

        //mysqli query to the database to select all from the staff table
        $sender = "select * from passenger " . $generator->filter_query();
