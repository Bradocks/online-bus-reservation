  ...
  <body>
    ...
    <main style="display: flex; flex-direction: column; width: 30%; margin-left: auto; margin-right: auto;">
        <div style="display: flex; flex-direction: column; background-color: #788585; padding: 2rem; color: white; border-radius: 20px;">
          ...
          >
            <li>
              <a style="color: white;" href="adminReportGeneration.php?type=listOfStaff"
                >STAFF REPORTS</a
              >
            </li>
            <li>
              <a style="color: white;" href="adminReportGeneration.php?type=listOfVehicles"
                >VEHICLE REPORTS</a
              >
            </li>

            <li>
              <a style="color: white;" href="adminReportGeneration.php?type=listOfUsers"
                >USER REPORTS</a
              >
            </li>

            <li>
              <a style="color: white;" href="adminReportGeneration.php?type=listOfpassengers"
                >PASSENGER REPORTS</a
              >
            </li>
