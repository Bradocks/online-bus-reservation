    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="/admin/manage_passengers.php?edit=<?php echo $user_to_update['id']; ?>">
                ...
                <div class="form-group">
                    <label>Role</label>
                    <input type="text" class="form-control" name="role" disabled value="<?php echo $user_to_update ? $user_to_update['role'] : 'passenger'; ?>" required>
                </div>
                <div class="form-group">
            ...
            <table class="table table-striped" style="width: 100%;">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='11'>No passengers available</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
